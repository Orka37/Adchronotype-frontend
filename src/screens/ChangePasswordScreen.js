...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#3D2B1F', fontSize: 17, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' },
  scroll:      { padding: 24, paddingTop: 28 },
  hint:        { color: '#8A6A4E', fontSize: 13, lineHeight: 20, marginBottom: 28 },
  lbl:         { color: '#fff', fontSize: 13, fontFamily: 'Lexend_600SemiBold', fontWeight: 'normal', marginBottom: 7, marginTop: 14 },
  ...
  strengthLabel:  { color: '#8A6A4E', fontSize: 11, fontFamily: 'Lexend_600SemiBold', fontWeight: 'normal', minWidth: 48 },
  ...
  btnText:     { color: '#fff', fontSize: 15, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' },
});
