...
const styles = StyleSheet.create({
  ...
  header: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 16 }, headerText: { alignItems: 'center', flex: 1 }, iconButton: { alignItems: 'center', height: 44, justifyContent: 'center', width: 44 }, heading: { color: '#3D2B1F', fontSize: 24, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, context: { color: '#8A6A4E', fontSize: 11, marginTop: 3 },
  ...
  pills: { gap: 9, marginBottom: 15 }, pill: { backgroundColor: '#FFFFFF', borderColor: '#F0E2D4', borderRadius: 12, borderWidth: 1, minWidth: 112, padding: 10 }, pillActive: { backgroundColor: '#FBEADB', borderColor: '#E07B3C' }, pillText: { color: '#4B5563', fontSize: 13, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, pillTextActive: { color: '#E07B3C' }, role: { color: '#8A6A4E', fontSize: 10, marginTop: 3, textTransform: 'capitalize' },
  sectionTabs: { backgroundColor: '#FBEADB', borderRadius: 13, flexDirection: 'row', marginBottom: 16, padding: 4 }, sectionTab: { alignItems: 'center', borderRadius: 10, flex: 1, gap: 3, justifyContent: 'center', minHeight: 50, paddingHorizontal: 3 }, sectionTabActive: { backgroundColor: '#E07B3C' }, sectionTabText: { color: '#8A6A4E', fontSize: 11, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, sectionTabTextActive: { color: '#fff' },
  routineEmpty: { alignItems: 'center', paddingVertical: 10 }, routineEmptyTitle: { color: '#3D2B1F', fontSize: 16, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal', marginTop: 8 }, progressTrack: { backgroundColor: '#F0E2D4', borderRadius: 4, height: 7, marginTop: 14, overflow: 'hidden', width: '100%' }, progressFill: { backgroundColor: '#E07B3C', height: 7 }, progressText: { color: '#8A6A4E', fontSize: 11, marginTop: 7 }, routineCard: { alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 12, flexDirection: 'row', gap: 10, marginBottom: 8, padding: 12 }, routineIcon: { alignItems: 'center', backgroundColor: '#FBEADB', borderRadius: 18, height: 36, justifyContent: 'center', width: 36 }, routineTime: { color: '#3D2B1F', fontSize: 14, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, routineNotes: { color: '#4B5563', fontSize: 12, lineHeight: 18, marginTop: 7 }, guidanceNote: { backgroundColor: '#FBEADB', borderRadius: 10, color: '#4B5563', fontSize: 11, lineHeight: 17, marginTop: 6, padding: 10 }, comparisonRow: { alignItems: 'flex-start', flexDirection: 'row', gap: 9, marginBottom: 10 }, comparisonText: { color: '#374151', flex: 1, fontSize: 12, lineHeight: 18 }, routineField: { flex: 1, marginBottom: 4 }, twoFields: { flexDirection: 'row', gap: 10 }, fieldHalf: { flex: 1 }, saveRoutine: { alignItems: 'flex-end', marginTop: 14 }, generalDisclaimer: { color: '#8A6A4E', fontSize: 10, lineHeight: 15, marginTop: 5 },
  summaryEmpty: { alignItems: 'center', flexDirection: 'row', gap: 12, paddingVertical: 8 }, summaryHero: { alignItems: 'center', backgroundColor: '#FBEADB', borderColor: '#F0D9C5', borderRadius: 13, borderWidth: 1, flexDirection: 'row', padding: 13 }, summaryEyebrow: { color: '#9A6A1E', fontSize: 9, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, summaryValue: { color: '#3D2B1F', fontSize: 22, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal', marginTop: 3 }, summaryDetail: { color: '#8A6A4E', fontSize: 10, lineHeight: 15, marginTop: 3 }, learningBanner: { alignItems: 'flex-start', backgroundColor: '#FBEED2', borderColor: '#F0D9A8', borderRadius: 10, borderWidth: 1, flexDirection: 'row', gap: 8, marginTop: 9, padding: 10 }, learningText: { color: '#9A6A1E', flex: 1, fontSize: 10, lineHeight: 15 }, historyTitle: { color: '#3D2B1F', fontSize: 13, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal', marginBottom: 5, marginTop: 14 }, summaryDay: { alignItems: 'flex-start', borderBottomColor: '#F0E2D4', borderBottomWidth: 1, flexDirection: 'row', paddingVertical: 10 }, dayDate: { width: 53 }, dayName: { color: '#374151', fontSize: 11, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, dayNumber: { color: '#8A6A4E', fontSize: 9, marginTop: 2 }, dayMetrics: { color: '#3D2B1F', fontSize: 11, lineHeight: 16 }, dayStatus: { color: '#d6a957', fontSize: 9, fontFamily: 'Lexend_700Bold', fontWeight: 'normal', marginTop: 3 }, dayStatusGood: { color: '#77d6b5' }, dayComparison: { color: '#8A6A4E', fontSize: 9, lineHeight: 14, marginTop: 3 }, dayNotes: { color: '#F0955A', fontSize: 9, marginTop: 3 },
  workingCard: { alignItems: 'flex-start', backgroundColor: '#E7F7EF', borderColor: '#B6E6CD', borderRadius: 12, borderWidth: 1, flexDirection: 'row', gap: 10, marginBottom: 11, padding: 12 }, workingTitle: { color: '#1F6B3A', fontSize: 13, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, workingText: { color: '#397C55', fontSize: 11, lineHeight: 17, marginTop: 3 }, leaveNoteButton: { alignItems: 'center', backgroundColor: '#E07B3C', borderRadius: 11, flexDirection: 'row', gap: 8, justifyContent: 'center', minHeight: 48 }, leaveNoteText: { color: '#fff', fontSize: 13, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, filterRow: { gap: 7, paddingBottom: 10 }, rangeRow: { flexDirection: 'row', gap: 7, marginBottom: 8 }, filterChip: { backgroundColor: '#FBEADB', borderColor: '#F0E2D4', borderRadius: 16, borderWidth: 1, justifyContent: 'center', minHeight: 32, paddingHorizontal: 11 }, filterChipActive: { backgroundColor: '#E07B3C', borderColor: '#E07B3C' }, filterChipText: { color: '#8A6A4E', fontSize: 10, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, filterChipTextActive: { color: '#fff' }, dayGroup: { borderTopColor: '#F0E2D4', borderTopWidth: 1, marginTop: 8, paddingTop: 10 }, dayLabel: { color: '#8A6A4E', fontSize: 10, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal', marginBottom: 8, textTransform: 'uppercase' }, handoffCard: { backgroundColor: '#FFFFFF', borderRadius: 12, marginBottom: 8, padding: 11 }, handoffHeader: { alignItems: 'center', flexDirection: 'row' }, avatarSmall: { alignItems: 'center', backgroundColor: '#FBEADB', borderRadius: 15, height: 30, justifyContent: 'center', marginRight: 8, width: 30 }, noteActions: { flexDirection: 'row', gap: 16, padding: 6 }, noteTags: { flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginTop: 9 }, noteTag: { backgroundColor: '#FBEADB', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4 }, noteTagText: { color: '#9A6A1E', fontSize: 9, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, handoffText: { color: '#3D2B1F', fontSize: 12, lineHeight: 18, marginTop: 9 }, sharedEvent: { alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 11, flexDirection: 'row', marginBottom: 7, minHeight: 54, padding: 10 }, sharedTime: { color: '#8A6A4E', fontSize: 10, fontFamily: 'Lexend_700Bold', fontWeight: 'normal', textAlign: 'right' }, modalSubtitle: { color: '#8A6A4E', fontSize: 11, marginTop: 3 }, handoffInput: { flex: 0, minHeight: 92, paddingTop: 12, textAlignVertical: 'top' }, characterCount: { color: '#8A6A4E', fontSize: 9, marginTop: 4, textAlign: 'right' },
  manageAccessButton: { alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 10, flexDirection: 'row', gap: 8, marginTop: 9, minHeight: 44, paddingHorizontal: 12 }, manageAccessText: { color: '#9A6A1E', flex: 1, fontSize: 12, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, wellnessStats: { flexDirection: 'row', gap: 10 }, wellnessStat: { backgroundColor: '#FBEADB', borderRadius: 12, flex: 1, padding: 13 }, hardWeek: { alignItems: 'flex-start', backgroundColor: '#FBEED2', borderColor: '#F0D9A8', borderRadius: 10, borderWidth: 1, flexDirection: 'row', gap: 8, marginTop: 10, padding: 10 }, hardWeekText: { color: '#9A6A1E', flex: 1, fontSize: 11, lineHeight: 17 }, checkRow: { alignItems: 'center', flexDirection: 'row', gap: 9, marginTop: 14 }, checkText: { color: '#374151', flex: 1, fontSize: 12, lineHeight: 18 }, supportLink: { alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 11, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8, minHeight: 52, padding: 12 }, supportLinkText: { color: '#F0955A', fontSize: 13, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, medicationLock: { alignItems: 'flex-start', backgroundColor: '#FBEED2', borderColor: '#F0D9A8', borderRadius: 14, borderWidth: 1, flexDirection: 'row', gap: 10, marginBottom: 14, padding: 14 }, medicationLockTitle: { color: '#9A6A1E', fontSize: 13, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, medicationLockText: { color: '#9A6A1E', fontSize: 11, lineHeight: 17, marginTop: 4 }, medicationCard: { backgroundColor: '#FFFFFF', borderRadius: 12, marginTop: 10, padding: 12 }, medicationHeader: { alignItems: 'center', flexDirection: 'row', gap: 8 }, clinicianLabel: { color: '#77d6b5', fontSize: 9, fontFamily: 'Lexend_700Bold', fontWeight: 'normal', marginTop: 7 }, medicationActions: { flexDirection: 'row', gap: 8, justifyContent: 'flex-end', marginTop: 10 }, medicationLog: { alignItems: 'center', borderBottomColor: '#F0E2D4', borderBottomWidth: 1, flexDirection: 'row', gap: 10, minHeight: 58 },
  prompt: { color: '#3D2B1F', fontSize: 20, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal', marginBottom: 12 }, eventGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 11, marginBottom: 12 }, eventButton: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#F0E2D4', borderRadius: 18, borderWidth: 1, minHeight: 132, justifyContent: 'center', padding: 15, width: '48%' }, eventIcon: { alignItems: 'center', borderRadius: 25, height: 50, justifyContent: 'center', marginBottom: 9, width: 50 }, eventTitle: { color: '#3D2B1F', fontSize: 17, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, eventHint: { color: '#8A6A4E', fontSize: 11, marginTop: 3 },
  customButton: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#F0E2D4', borderRadius: 14, borderWidth: 1, flexDirection: 'row', gap: 10, marginBottom: 16, minHeight: 52, paddingHorizontal: 15 }, customButtonText: { color: '#4B5563', flex: 1, fontSize: 13, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' },
  section: { backgroundColor: '#FFFFFF', borderColor: '#F0E2D4', borderRadius: 16, borderWidth: 1, marginBottom: 14, padding: 16 }, sectionTitle: { color: '#3D2B1F', fontSize: 16, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal', marginBottom: 12 },
  emptyState: { alignItems: 'center', paddingVertical: 18 }, empty: { color: '#8A6A4E', fontSize: 12, lineHeight: 18, marginTop: 9, textAlign: 'center' }, timelineRow: { alignItems: 'center', borderBottomColor: '#F0E2D4', borderBottomWidth: 1, flexDirection: 'row', minHeight: 55 }, timelineLast: { borderBottomWidth: 0 }, timelineDot: { backgroundColor: '#E07B3C', borderRadius: 5, height: 10, marginRight: 10, width: 10 }, timelineTime: { color: '#8A6A4E', fontSize: 12, fontFamily: 'Lexend_700Bold', fontWeight: 'normal', width: 78 }, timelineTitle: { color: '#3D2B1F', fontSize: 13, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, loggedBy: { color: '#8A6A4E', fontSize: 10 },
  inputRow: { alignItems: 'center', flexDirection: 'row', gap: 10 }, input: { backgroundColor: '#FFFFFF', borderColor: '#F0E2D4', borderRadius: 11, borderWidth: 1, color: '#3D2B1F', flex: 1, fontSize: 14, minHeight: 46, paddingHorizontal: 13 }, noteInput: { flex: 0, minHeight: 72, paddingTop: 12, textAlignVertical: 'top' }, smallButton: { alignItems: 'center', backgroundColor: '#E07B3C', borderRadius: 10, justifyContent: 'center', minHeight: 44, paddingHorizontal: 14 }, secondaryButton: { backgroundColor: '#F0E2D4' }, dangerButton: { backgroundColor: '#9f2f43' }, disabled: { opacity: 0.45 }, smallButtonText: { color: '#fff', fontSize: 12, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' },
  rowCard: { alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 12, flexDirection: 'row', gap: 9, marginBottom: 8, padding: 11 }, grow: { flex: 1 }, rowTitle: { color: '#3D2B1F', fontSize: 13, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, muted: { color: '#8A6A4E', fontSize: 11, marginTop: 3 }, mutedBlock: { color: '#8A6A4E', fontSize: 12, lineHeight: 18, marginBottom: 11 }, avatar: { alignItems: 'center', backgroundColor: '#FBEADB', borderRadius: 19, height: 38, justifyContent: 'center', width: 38 }, readOnly: { color: '#8A6A4E', fontSize: 13, lineHeight: 20 }, loader: { marginVertical: 28 },
  modalOverlay: { alignItems: 'center', backgroundColor: 'rgba(0,0,0,.78)', flex: 1, justifyContent: 'center', padding: 20 }, modalCard: { backgroundColor: '#FFFFFF', borderColor: '#F0E2D4', borderRadius: 20, borderWidth: 1, maxWidth: 480, padding: 20, width: '100%' }, modalHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, modalTitle: { color: '#3D2B1F', fontSize: 20, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' }, fieldLabel: { color: '#4B5563', fontSize: 12, fontFamily: 'Lexend_700Bold', fontWeight: 'normal', marginBottom: 8, marginTop: 13 }, typeWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, typeChip: { backgroundColor: '#FBEADB', borderRadius: 18, minHeight: 38, paddingHorizontal: 13, justifyContent: 'center' }, typeChipActive: { backgroundColor: '#E07B3C' }, typeChipText: { color: '#8A6A4E', fontSize: 12, fontFamily: 'Lexend_700Bold', fontWeight: 'normal' }, typeChipTextActive: { color: '#fff' }, modalActions: { flexDirection: 'row', gap: 10, justifyContent: 'flex-end', marginTop: 18 },
  navWrap: { backgroundColor: '#FDF6F0', borderTopColor: '#F0E2D4', borderTopWidth: 1, bottom: 0, left: 0, position: 'absolute', right: 0 }, nav: { flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 10 }, navItem: { alignItems: 'center', minWidth: 54, position: 'relative' }, navLabel: { color: '#8A6A4E', fontSize: 10, marginTop: 4 }, navActive: { color: '#F0955A' }, badge: { alignItems: 'center', backgroundColor: '#D9694F', borderRadius: 9, height: 18, justifyContent: 'center', position: 'absolute', right: 5, top: -7, width: 18, zIndex: 2 }, badgeText: { color: '#fff', fontSize: 9, fontFamily: 'Lexend_800ExtraBold', fontWeight: 'normal' },
});
